...
COMPRESSED_BIN=$(echo ${INPUT_BIN} | sed s/'\.bin$'/'_axgzip.bin'/g)
...
rm -f ${PACK_OUTPUT_DIR}/${COMPRESSED_BIN}
${GERNERAL_BIN}/ax_gzip -9 ${PACK_OUTPUT_DIR}/${INPUT_BIN}

python3 ${GERNERAL_BIN}/imgsign/sec_boot_AX620E_sign.py -i ${PACK_OUTPUT_DIR}/${COMPRESSED_BIN} \
